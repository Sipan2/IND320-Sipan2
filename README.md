...
The work log is within the required 300-500 words. Streamlit deployment is awaiting account sign-in. The screencast will be recorded separately.
...
For Streamlit Community Cloud, use branch `main`, entry file `app.py` and Python 3.12 or newer. The app link will be added after deployment.
